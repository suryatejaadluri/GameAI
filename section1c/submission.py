...
class CustomEvalFn:
    ...
    def score(self, game, my_player=None):
        ...
        elif len(game.get_opponent_moves(my_player)) <3:
...
class CustomPlayer:
    ...
    def __init__(self, search_depth=25, eval_fn=CustomEvalFn()):
...
#                 print(killer_moves)
                ...
                killer_moves[best_move]=abs(utilityscore*6)
    ...
    def utility(self, game, my_turn):
        ...
        if len(game.get_player_moves(self)) == 0:
            return -100
        elif len(game.get_opponent_moves(self)) == 0:
            return 100
        else:
