...
# Credits if any
# 1)For - Section 1.a MiniMax - Artificial Intelligence Modren Approach 3rd Edition - MiniMax Pseudo Code
# 2)
# 3)
...
def minimax(player, game, time_left, depth, my_turn=True):
    ...
    def MaxValue(player,game,time_left,depth,my_turn):
        ...
        if len(game.get_active_moves()) == 0 or depth ==0 or time_left()<1:
